              ...
              <div className="space-y-6">
                ...
                <div className="pt-4 border-t border-gray-800">
                  ...
                  <div className="space-y-3">
                    ...
                    >
                      <div className="w-8 h-8 bg-gray-900 border border-gray-700 rounded flex items-center justify-center mr-3 hover:bg-green-500 hover:text-black transition-colors">
