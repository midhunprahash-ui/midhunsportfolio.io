          ...
          <div className="text-center max-w-md">
            ...
            <div className="mt-8 text-center">
              ...
              <div className="flex justify-center space-x-4">
                ...
                <a href="https://github.com/midhunprahash-ui" className="w-10 h-10 bg-gray-800 border border-gray-700 rounded-lg flex items-center justify-center hover:bg-blue-400 hover:text-black transition-colors duration-200" target="_blank" rel="noopener noreferrer">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
